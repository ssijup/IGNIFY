...
from .models import Userdetails,Products,Category,Cart,Useraddress,Coupon,BannerVedio,ProductsSerializer,Order,GENDER_CHOICE,PAYMENT_METHOD_CHOICES,STATUS_CHOICES,Payment,Subcategory,Variants,Variantoptions,Productimages
